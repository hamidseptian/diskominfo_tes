...
<div id="container">
	<h1>
		Data Transaksi tanggal <?php echo $tglawal ?> sampai tanggal <?php echo $tglakhir ?>
	</h1>
	...
	<div id="body">
		...
		<a href="<?php echo base_url() ?>user/bo/print_hasil_cari/<?php echo $tglawaldb ?>/<?php echo $tglakhirdb ?>" target="_blank">Print Pencarian</a>
		<?php }else{
